...
```bash
curl -fsSL https://github.com/Ruraam/debup/releases/latest/download/debup_3.1.2_all.deb -o /tmp/debup.deb && sudo apt-get install -y /tmp/debup.deb && rm -f /tmp/debup.deb
```
